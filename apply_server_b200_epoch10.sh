#!/bin/bash
#SBATCH --job-name=sft_open_ep10_b200
...
#SBATCH --output=%j_sft_open_ep10_b200.txt
#SBATCH --mail-user=linhai.ma@yale.edu

set -euo pipefail

REPO_ROOT="/nfs/roberts/project/pi_sjf37/lm2445/PV_multiagent/sft_open"
PIPELINE_SH="${REPO_ROOT}/sft_epoch10_raw2shot_to_finben_b200.sh"
...
export RAW_NUM_FEWSHOT="${RAW_NUM_FEWSHOT:-2}"
export SFT_NUM_FEWSHOT="${SFT_NUM_FEWSHOT:-0}"
...
echo "EPOCHS=${EPOCHS}"
echo "RAW_NUM_FEWSHOT=${RAW_NUM_FEWSHOT}"
echo "SFT_NUM_FEWSHOT=${SFT_NUM_FEWSHOT}"
