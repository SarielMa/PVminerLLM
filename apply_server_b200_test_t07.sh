#!/bin/bash
#SBATCH --job-name=test_open_ep10_b200_t07
...
#SBATCH --output=%j_test_open_ep10_b200_t07.txt
#SBATCH --mail-user=linhai.ma@yale.edu

set -euo pipefail

REPO_ROOT="/nfs/roberts/project/pi_sjf37/lm2445/PV_multiagent/sft_open"
PIPELINE_SH="${REPO_ROOT}/test_epoch10_b200_t07_3runs.sh"
